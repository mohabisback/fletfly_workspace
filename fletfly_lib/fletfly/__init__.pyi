from ._core._route import Route as Route, use as use, Zone as Zone, Shared as Shared
...
from ._core._Router import Router as Router, StackMode as StackMode
from ._core._Router import fly as fly, data as data, slot as slot
__all__=[
    'Route', 'Shared', 'Zone', 'use',
    'layout', 'view', 'loader',
    'fly_in', 'fly_out', 'fly_ins', 'fly_outs',
    'child', 'index', 'children',
    'Router', 'StackMode', 'fly', 'data', 'slot',
    ]