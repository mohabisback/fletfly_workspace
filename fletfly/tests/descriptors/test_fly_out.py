...
def test_fly_out_decorator_on_class():
    ...
    assert getattr(SampleClass, "_fletfly_fly_out")[0].get("inheritable", "not there")== "not there"
    assert getattr(SampleClass, "_fletfly_fly_out")[0].get("apply_per_view", "not there") == "not there"
    assert getattr(SampleClass, "_fletfly_fly_out")[0].get("kwargs", "not there") == {}
...
def test_fly_out_via_class_attribute_with_args_on_class():
    ...
    assert getattr(SampleClass, "_fletfly_fly_out")[0].get("inheritable", "not there") is True
    assert getattr(SampleClass, "_fletfly_fly_out")[0].get("apply_per_view", "not there") is False
    assert getattr(SampleClass, "_fletfly_fly_out")[0].get("kwargs", "not there") == {"role":"user"}
...
def test_fly_out_decorator_on_function():
    ...
    assert getattr(sample_func, "_fletfly_fly_out")[0].get("inheritable", "not there") == "not there"
    assert getattr(sample_func, "_fletfly_fly_out")[0].get("apply_per_view", "not there") == "not there"
    assert getattr(sample_func, "_fletfly_fly_out")[0].get("kwargs", "not there") == {}
...
def test_fly_out_decorator_with_args_on_function():
    ...
    assert getattr(sample_func, "_fletfly_fly_out")[0].get("kwargs", "not there") == {"role":"user"}
...
def test_fly_out_via_instance_attribute_on_function():
    ...
    assert aw.fly_outs[0]["inheritable"] == False
    assert aw.fly_outs[0]["apply_per_view"] == False
    assert aw.fly_outs[0]["kwargs"] == {}
...
def test_fly_out_via_instance_attribute_with_args_on_function():
    ...
    assert aw.fly_outs[0]["kwargs"]== {"role":"user"}
    assert aw.fly_outs[0]["kwargs"].get("inheritable", "not there") == "not there"
